                        ...
                        <tr wire:key="order-row-{{ $order->id }}" class="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                <div class="inline-flex items-center space-x-1">
                                           <!-- NEW PROCESS / PRODUCTION BUTTON -->
                                    <button  class="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs font-medium rounded-lg transition flex items-center gap-1">
                                        <a href="{{ route('order-process', ['order' => $order->id]) }}" class="text-indigo-600 hover:underline">
