											...
											<tr>
                                              <td class="p-7">
												    ...
												    <input type="text"  name="twelve[12_from]" class="onetime"  value="{{($decodedDAta['twelve']['12_from'])??''}}"> <P STYLE = "COLOR:RED"><B>[ CALL AURTHORIZED PERSON OF THE ESTABLISHMENT AND TELL HIM NOT TO DISCLOSE THE INVOLVEMENT OF RAJ CONSULTANCY REGARARING GREVIANCE MATTER IF THEY RECEIVED CALL FROM EPFO]</B></P>
                                                     ...
                                                     <?php if((isset($decodedDAta['one']['1_eonm']) && $decodedDAta['one']['1_eonm']!="") && (isset($decodedDAta['two']['2_from']) && $decodedDAta['two']['2_from']!="") && (isset($decodedDAta['five']['5_from'])  && $decodedDAta['five']['5_from']!="") && (isset($decodedDAta['seven']['7_from']) && $decodedDAta['seven']['7_from']!="")){?>
                                            
                                                
                                                Even after completing all these processes and after giving the several reminders in mail, till date my DSC is not active. Due to this I can not approve the KYC details which are filed by my employees. You are requested to approve my request of DSC activation so that I can do my work related to PF smoothly. Thank you<br\>
                                                ...
                                                <?php }?>
													...
													<td class="p-7">
														<?php 
													if(isset($decodedDAta['twelve']['date_time']) && $decodedDAta['twelve']['date_time']!="" && $decodedDAta['twelve']['date_time']!=null){
