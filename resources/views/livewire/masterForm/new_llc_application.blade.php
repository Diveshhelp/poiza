										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													8. NEW ID & PASSWORD SAVE IN 2,25 SCREEN NO 20. IF COMPANY IS NOT IN SOFTWARE THEN SAVE IN ITS FOLDER.</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. ADD COMPANY NAME & ADDRESS IN OUR SOFTWARE FROM MENU NO. 2;1;10;7 IF COMPANY IS NOT IN SOFTWARE.</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													14. UPDATE REGISTRATION ENTRY IN SPREAD SHEET AVAILABLE IN GMAIL>DHIRUBHAI LABLE
