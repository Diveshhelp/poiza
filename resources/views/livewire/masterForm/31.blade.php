										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. INSERT PF ID <input style="width:160px;"  type="text" name="ten[10_unam]" value="{{($decodedDAta['ten']['10_unam'])??''}}">  & PASSWORD <input  style="width:120px;"  type="text" name="ten[10_pass]" value="{{($decodedDAta['ten']['10_pass'])??''}}"> IN 2;25 SCR NO 18. 
												</td>
												<td class="p-7">
											...
											<tr>
	                                           ...
	                                           <tr>
												<td class="p-7">
													<input type="checkbox" name="thirtyfive[checkbox]"  <?php if(isset($decodedDAta['thirtyfive']['checkbox']) && $decodedDAta['thirtyfive']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													...
													<td class="p-7">
														<textarea rows="1"  name="thirtyfive[comment]" class="w-100">{{($decodedDAta['thirtyfive']['comment'])??''}}</textarea>
													</td>
													<td class="p-7">
														{{($decodedDAta['thirtyfive']['user_name'])??''}}
													</td>
													<td class="p-7">
														<?php 
													if(isset($decodedDAta['thirtyfive']['date_time']) && $decodedDAta['thirtyfive']['date_time']!=""){
														$timestamp =$decodedDAta['thirtyfive']['date_time'];
														$date = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $timestamp, "UTC");
														$date->setTimezone($timezone);
														$NewDate= $date->format("Y-m-d H:i:s");
														echo date('d-m-Y h:i A',strtotime($NewDate));
													...
													<input type="hidden" value="{{($decodedDAta['thirtyfive']['user_name'])??''}}" name="thirtyfive[savedby]">
											</tr>
											<tr>
												<td class="p-7">
