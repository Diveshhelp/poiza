										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													4. OPEN GLWF PORTAL BY USING THIS LINK <a href="https://glwbgujarat.in/crm/" target="_blank"> click to glwf link</a> & GO TO E-SEVA, CLICK ON "REGISTRATION NOW" BUTOON & SELECT OPTION  "NO" & SUBMIT
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													5. PLEASE FILL MANDATORY FIELDS & FUND CYCLE THEN SUBMIT APPLICATION
												</td>
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="six[checkbox]"  <?php if(isset($decodedDAta['six']['checkbox']) && $decodedDAta['six']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													6. ESTABLISHMENT WILL RECEIVED USER ID AND PASSWORD AFTER APPROVAL OF APPLICATOIN BY GLWF DEPARTMENT 
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. RESET PASSWORD BY USING THIS LINK htts://glwbgujarat.in/crn</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. NEW G.L.W.F. ID
														<input type="text" name="eight[8_glwf_id]" value="{{($decodedDAta['eight']['8_glwf_id'])??''}}"> & PASSWORD
														<input type="text" name="eight[8_glwf_pass]" value="{{($decodedDAta['eight']['8_glwf_pass'])??''}}">SAVE IN COMPANY MASTER IF COMPANY IS NOT IN SOFTWARE THEN SAVE IN FOLDER.</BR>
												    </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. LOGIN WITH NEW PASSWORD, CLICK ON VIEW DETAILS OF ONLINE PAYMENT & PAY GLWF DUES BY CLICK ON PAY OPTION.
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													10. DOWNLOAD, SAVE & MAIL GLWF PAYMENT RECEIPT</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. INSERT BILL ENTRY IN EXCELL SHEET SAVED IN THE LABLE OF DHIRUBHAI OF RS.
													<input type="text" name="eleven[11_con_fees]" value="{{($decodedDAta['eleven']['11_con_fees'])??''}}">
													</td>
												<td class="p-7">
												...
												<td class="p-7"><input type="checkbox" name="twelve[checkbox]" <?php if(isset($decodedDAta['twelve']['checkbox']) && $decodedDAta['twelve']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													12. UPDATE GLWF REPORTING IN REPORT MASTER IN THE SOFTWARE OF RESPECTIVE EMPLOYEES
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="thirteen[checkbox]" <?php if(isset($decodedDAta['thirteen']['checkbox']) && $decodedDAta['thirteen']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													13. MARK YES STATUS IN GLWF IN COMPANY MASTER
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="fourteen[checkbox]" <?php if(isset($decodedDAta['fourteen']['checkbox']) && $decodedDAta['fourteen']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													14. UPDATE GLWF PORTAL USER ID AND GLWF PASSWORD IN COMPANY MASTER
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="fifteen[checkbox]" <?php if(isset($decodedDAta['fifteen']['checkbox']) && $decodedDAta['fifteen']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													15. MARK THIS TICKET AS CLOSE
												</td>
												<td class="p-7">
