                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mb-3">
                                    <div class="text-gray-800 font-medium text-sm leading-relaxed">
                                        @switch($step)
                                            @case('one')
												DOCUMENT RECEIVED FOR NEW FACTORY LICENCE
                                                @break
                                            @case('two')
												STABLISHMENT FOLDER DEVELOP IN RAJKOT FOLDER
                                                @break
                                            @case('three')
											ALL MASTER DOC. SCAN & SAVE IN RAJKOT / ESTABLISHMENT FOLDER	
                                                @break
                                            @case('four')
												ESTABLISHMENT MAIL ID SAVE IN GMAIL 
											@case('five')
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 pt-3 border-t border-gray-200">
                                    ...
                                    <div class="space-y-2 text-xs">
                                        <div>
											...
											@if(isset($processSteps[$step]) && $processSteps[$step]['user_name']!="")
