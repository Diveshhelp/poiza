										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													4. SEND ESTABLISHMENT CONTECT PERSON MOBILE NUMBER AND NAME TO PF INSPECTOR & CALL HIM TO INFROM ABOUT PF INSPECTION
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="five[checkbox]"  <?php if(isset($decodedDAta['five']['checkbox']) && $decodedDAta['five']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													5. PF USER ID<input style="width:160px;"  type="text" name="five[7_unam]" value="{{($decodedDAta['five']['7_unam'])??''}}"> PASSWORD<input  style="width:100px;"  type="text" name="five[7_pass]" value="{{($decodedDAta['five']['7_pass'])??''}}">
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="six[checkbox]"  <?php if(isset($decodedDAta['six']['checkbox']) && $decodedDAta['six']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													6. PRINT TIME LIMIT EXTENSION LETTER ON LETTER HEAD
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. DIGITAL SIGNATURE UPLOAD STATUS &nbsp;&nbsp;&nbsp;
													 <input type="radio" id="yes" name="eight[radio1]" value="Yes" <?php if(isset($decodedDAta['eight']['radio1']) && $decodedDAta['eight']['radio1']=="Yes") { echo "checked=checked";}?>>
                                                     <label for="html">Active</label>&nbsp;&nbsp;&nbsp;
                                                    <input type="radio" id="no" name="eight[radio1]" value="No" <?php if(isset($decodedDAta['eight']['radio1']) && $decodedDAta['eight']['radio1']=="No") { echo "checked=checked";}?>>
                                                    <label for="css">In-Active</label> <BR>IF NOT THEN RECEIVE FROM ESTABLISHMENT & REGISTER IN PF PORTAL & INWARD LETTER TO PF OFFICE
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. CANCEL CHEQUE / BANK DETAILS</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. LETTER PAD A4 SIZE - 6 COPY & RUBBER STAMP 
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]"  <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													11. DATE OF SETUP 
													<input type="text"  name="elevan[11_setup]" class="onetime"  value="{{($decodedDAta['elevan']['11_setup'])??''}}"> PF W.E.F. 
											...
											<tr>
												<td class="p-7">
													...
													12. LAST PF INSPECTION / 7A ORDER DATE 
													<input type="text"  name="twelve[12_ins]" class="onetime"  value="{{($decodedDAta['twelve']['12_ins'])??''}}"> (IF PF INSPECTION / 7A CASE COMPLETED)
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													14. PAYMENT POSITION FOR INSPECTION PERIOD FROM MENU NO. 1;14;1;1</td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													15. ARE THERE EXCLUDED EMPLOYEES ? &nbsp;&nbsp;&nbsp;
													 <input type="radio" id="yes" name="fifteen[radio1]" value="Yes" <?php if(isset($decodedDAta['fifteen']['radio1']) && $decodedDAta['fifteen']['radio1']=="Yes") { echo "checked=checked";}?>>
                                                     <label for="html">Yes</label>&nbsp;&nbsp;&nbsp;
                                                    <input type="radio" id="no" name="fifteen[radio1]" value="No" <?php if(isset($decodedDAta['fifteen']['radio1']) && $decodedDAta['fifteen']['radio1']=="No") { echo "checked=checked";}?>>
...
<tr>
												<td class="p-7">
													...
													16. BALANCE SHEET LAST 5 YEAR OR DATE OF SETUP WHICH EVER IS OLD</td>
													<td class="p-7">
                                            ...
                                            <tr>
												<td class="p-7">
													...
													<input style="width:160px;" type="text" name="eighteen[18_fees]" value="{{($decodedDAta['eighteen']['18_fees'])??''}}">
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													18. IF ESTABLISHMENT IS CLOSED, THAN AFFIDAVITE FROM EMPLOYER FOR CLOSURE</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													19. INSPECTION IS OVER & VISIT NOTE RECEIVED FORM INSPECTOR ? &nbsp;&nbsp;&nbsp;
												...
												<td class="p-7">
													...
													20. WEATHER DUES ARE GENERATED BY INSPECTOR ? &nbsp;&nbsp;&nbsp;
											...
											<tr>
												<td class="p-7">
													...
													21. IF DUES ARE GENERATED THAN TAKE FOLLOWUP FOR PF PAYMENT AND PRINT PAID STATEMENT & CRN</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													22. DO ENTRY OF CRN, TRRN AND DATE OF PAYMENT IN 1;1;5 OR 15
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													23. PREPARE REPLY FOR VISIT NOTE AND MAIL TO ESTABLISHMENT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													24. SUBMIT REPLY LETTER TO CONCERN PF OFFICE AND MAIL O/C COPY TO ESATBLISHMENT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													25. DO ENTRY IN ESTABLISHMENT HISTORY IN MENU NO. 16;18</td>
													<td class="p-7">
										    ...
										    <tr>
												<td class="p-7">
													...
													26. MARK THIS TICKET AS CLOSED</td>
													<td class="p-7">
