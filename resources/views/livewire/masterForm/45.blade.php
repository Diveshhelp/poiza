										...
										<table class="w-100" border="1">
											...
											<tr>	
												<td class="p-7">
													...
													3. LLS WITH EFFECT FROM 
													<input type="text"  name="three[3_from]" class="onetime"  value="{{($decodedDAta['three']['3_from'])??''}}"> TO 
													<input type="text" name="three[3_to]" class="onetime" value="{{($decodedDAta['three']['3_to'])??''}}"> </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													4. TOTAL EMPLOYEE<input type="text" name="four[4_emp]" value="{{($decodedDAta['four']['4_emp'])??''}}">
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													5. REG. FEE Rs.<input style="width:60px;" type="text" name="five[5_reg_fee]" value="{{($decodedDAta['five']['5_reg_fee'])??''}}">, 
													SEC. DEPOSIT (EE*540) Rs.<input style="width:60px;" type="text" name="five[5_sec_fee]" value="{{($decodedDAta['five']['5_sec_fee'])??''}}">
 													CONSULTING FEES Rs.<input style="width:60px;"  type="text" name="five[5_our_fee]" value="{{($decodedDAta['five']['5_our_fee'])??''}}">,
													OTHER EXP.<input style="width:60px;"  type="text" name="five[5_other_fee]" value="{{($decodedDAta['five']['5_other_fee'])??''}}">	
													TOTAL Rs.<input style="width:60px;"  type="text" name="five[5_total_fee]" value="{{($decodedDAta['five']['5_total_fee'])??''}}"> 
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. PREAPARE SECURITY DEPOSITE CHALLAN AND GET SIGN & SEAL OF CONCERN LABOUR OFFICE AND PAY AT TRESARY BRANCH
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. CREATE NEW INVESTOR REGISTRATION AT IFP PORTAL
                                                    </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. NEW IFP ID <input type="text" name="nine[ifp_id]" value="{{($decodedDAta['nine']['ifp_id'])??''}}">& PASSWORD 
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													10. LOG IN INTO IFP PORTAL USING ABOVE ID, PASSWORD & CREATE NEW PROJECT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="twlve[checkbox]" <?php if(isset($decodedDAta['twlve']['checkbox']) && $decodedDAta['twlve']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													11. GO TO CREATE PROJECT ->PROJECT REQUEST LIST ->CLICK ON CLICK HERE ->CLICK ON "APPLY OF LICENSE UNDER LABOUR ACT -> SELECT LANGAUGE AND CONCERN LOCATION</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													12. FILL UP ALL DETAILS IN FORM & SUBMIT THE APPLICATION</td>
											...
											<tr>
												<td class="p-7">
													...
													13. PAY LICENSE FEES ONLINE AND NOTE DOWN LICENSE APPLICATION NO
											...
											<tr>
												<td class="p-7">
													...
													14. SEND APPLICATION NO., OWNER NAME, COMPANY NAME AND NO. OF EMPLOYEES TO SIR</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													15. DOWNLOAD, SAVE & MAIL LABOUR LICENCE COPY </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													16. ADD FOLLWING DETAILS IN ADDRESS MASTER IF COMPANY IS NOT CREATED IN OUR SOFTWARE<br>
											...
											<tr>
												<td class="p-7">
													...
													17. DO ENTRY IN CALANDER FOR EXPIRING YEAR
													</td>
													<td class="p-7">
