			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-secondary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form action="" id="createProject" method="POST"
										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="five[checkbox]"  <?php if(isset($decodedDAta['five']['checkbox']) && $decodedDAta['five']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													5. OPEN SHRAM SUVIDHA PORTAL & CREATE USER ID<input style="width:160px;"  type="text" name="five[7_unam]" value="{{($decodedDAta['five']['7_unam'])??''}}"> PASSWORD<input  style="width:100px;"  type="text" name="five[7_pass]" value="{{($decodedDAta['five']['7_pass'])??''}}">
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. INSERT PF ID <input style="width:160px;"  type="text" name="ten[7_unam]" value="{{($decodedDAta['ten']['7_unam'])??''}}">  & PASSWORD <input  style="width:120px;"  type="text" name="ten[7_pass]" value="{{($decodedDAta['ten']['7_pass'])??''}}"> IN 2;25 SCR NO 18. 
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													12. ALOTE FILE NO IN 2;25 SCR 1 DISP 4</td>
													<td class="p-7">
                                            ...
                                            <tr>
												<td class="p-7">
													<input type="checkbox" name="thirytwo[checkbox]"  <?php if(isset($decodedDAta['thirytwo']['checkbox']) && $decodedDAta['thirytwo']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													13. VERIFY THAT THE CONCERN_PF_OFF_CODE MENTIONED IN THE  PF CODE LETTER AND CODE SAVED IN 2,25 SCR NO. 25 WHICH MUST BE SAME. IF THE CODE IS NOT SAME THEN CHANGE IT FROM 2;25 SCR 25<BR><B>Example : GJRAJ, GJAHD, SRSRT, GJVAT, PUPUN ETC.<B/></BR></td>
													<td class="p-7">
														<textarea rows="1"  name="thirytwo[comment]" class="w-100">{{($decodedDAta['thirytwo']['comment'])??''}}</textarea>
													</td>
													<td class="p-7">
														{{($decodedDAta['thirytwo']['user_name'])??''}}
													</td>
													<td class="p-7">
														<?php 
													if(isset($decodedDAta['thirytwo']['date_time']) && $decodedDAta['thirytwo']['date_time']!=""){
														$timestamp =$decodedDAta['thirytwo']['date_time'];
														$date = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $timestamp, "UTC");
														$date->setTimezone($timezone);
														$NewDate= $date->format("Y-m-d H:i:s");
														echo date('d-m-Y h:i A',strtotime($NewDate));
													...
													<input type="hidden" value="{{($decodedDAta['thirytwo']['user_name'])??''}}" name="thirytwo[savedby]">
											</tr>
											...
											<tr>
												<td class="p-7">
													...
													15. IF EST IS PERTAINING TO ANY BRANCH THEN ADD REMARKS FOR MAIL IN MENU NO. 16;5</td>
													<td class="p-7">
...
<tr>
											...
											<tr>
												...
												<td class="p-7">
													...
													22. DOWNLOAD PF CODE LETTER, SAVE TO RAJKOT FOLDER & MAIL TO ESTABLISHMENT.</td>
													<td class="p-7">
										...
										<tr>
											...
											<tr>
												<td class="p-7">
													...
													30. ADD CONTACT NO WITH EST NAME IN jignashanumbers2@gmail.com</td>
													<td class="p-7">
                                            ...
                                            <tr>
												<td class="p-7">
													...
													31. UPDATE DIGITAL INWARD ENTRY IN THE ORIGINAL SOFTWARE IN MENU NO. 16;20;1</td>
													<td class="p-7">
                                            ...
                                            <tr>
												<td class="p-7">
													...
													32. MARK THIS TICKET AS CLOSED</td>
													<td class="p-7">
