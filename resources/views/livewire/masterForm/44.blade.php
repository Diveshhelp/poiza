										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="six[checkbox]"  <?php if(isset($decodedDAta['six']['checkbox']) && $decodedDAta['six']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													6. FOR PF REGISTRATRATION GO TO SHRAM SUVIDHA PORTAL, CREATE SHRAM SUVIDHA ID <input style="width:120px;"  type="text" name="six_one[mobile_number]" value="{{($decodedDAta['six_one']['mobile_number'])??''}}">PASSWORD<input style="width:120px;"  type="text" name="six_two[mobile_number]" value="{{($decodedDAta['six_two']['mobile_number'])??''}}">
                                                  
                                                  AND APPLY FOR PF REGISTRATION ID<input style="width:120px;"  type="text" name="six_one1[mobile_number1]" value="{{($decodedDAta['six_one1']['mobile_number1'])??''}}">PASSWORD<input style="width:120px;"  type="text" name="six_two2[mobile_number2]" value="{{($decodedDAta['six_two2']['mobile_number2'])??''}}">
                                            ...
                                            */ ?>
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													8. OPEN ESTABLISHMENT IN OUR SOFTWARE FROM LOGIN DPA WITH ALL AVAILABLE DATA
												...
												<td class="p-7">
													...
													9. UPDATE MAIL ID IN COMPANY MASTER, IF EST IS PERTAINING TO ANY BRANCH THEN ADD MAIL ID OF BRANCH IN CC
												...
												<td class="p-7">
													...
													10. UPDATE GST CERTIFICATE NO. IN COMPANY MASTER
 </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													11. SELECT MUSTER & WAGE REGISTER  AND WAGE SLIP FORMAT  
	                                        ...
	                                        <tr>
												<td class="p-7">
													...
													12. SELECT HEAD OF ALLOWANCE AND DEDCUTION
</td></td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													13. SAVE IN COMPANY MSTER PF ID & PW AND SHRAM SUVIDHA ID & PW
...
<tr>
												<td class="p-7">
													...
													14. UPDATE OTHER ALL DETAILS IN COMPANY MASTER AS PER THE DOCUMENTS AND DATA AVAILABLE WITH US
...
<tr>
												<td class="p-7">
													...
													15. UPDATE FEES AND BILL FIRM NAME
											...
											<tr>
												...
												<td class="p-7">
													...
													18. IF DSC IS WITH US THEN UPDATE THE INWARD ENTRY IN SOFTWARE AND CREATE A TICKIT FOR DSC ACTIVATION 
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													19. PREPARE NEW UPLOAD EXCEL OF EMPLOYEES WITH ALL KYC DETAILS
                                            ...
                                            <tr>
												<td class="p-7">
													...
													27. SELECT FORMATE OF WAGE SLIP 
                                            ...
                                            <tr>
												<td class="p-7">
													...
													28.DESIGN EXCEL SALARY STRUCUTRE AS PER THE REQUIREMENT OF THE COMPANY
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													29.UPDATE REGISTRATION ENTRY IN SPREAD SHEET AVAILABLE IN GMAIL>DHIRUBHAI LABLE
</td>
													<td class="p-7">
