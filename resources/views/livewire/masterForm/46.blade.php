										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													2. AS PER CHECK LIST MISSING DOCUMENT                                                                         
												   	<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													4. <B>LAST APPLIED DATA:</B> <BR>TOTAL EMPLOYEES
													<input style="width:70px;" type="text" name="four[4_tot_ee]" value="{{($decodedDAta['four']['4_tot_ee'])??''}}">, REGISTRATION FEES RS.
													<input style="width:70px;" type="text" name="four[4_reg_fee]" value="{{($decodedDAta['four']['4_reg_fee'])??''}}">SECURITY DEPOSITE (EE* RS.270)
													<input style="width:70px;"  type="text" name="four[4_sec_dep]" value="{{($decodedDAta['four']['4_sec_dep'])??''}}">
													</BR>
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													5. <B>RENUAL DATA :</B><BR> TOTAL EMPLOYEES<input style="width:70px;" type="text" name="five[5_tot_ee]" value="{{($decodedDAta['five']['5_tot_ee'])??''}}">, 
													REG. FEE Rs.<input style="width:70px;" type="text" name="five[5_reg_fee]" value="{{($decodedDAta['five']['5_reg_fee'])??''}}">, 
													SEC. DEPOSIT (EE*90) Rs.<input style="width:70px;" type="text" name="five[5_sec_fee]" value="{{($decodedDAta['five']['5_sec_fee'])??''}}">
 													CONSULTING FEES Rs.<input style="width:70px;"  type="text" name="five[5_our_fee]" value="{{($decodedDAta['five']['5_our_fee'])??''}}">,
													OTHER EXP.<input style="width:70px;"  type="text" name="five[5_other_fee]" value="{{($decodedDAta['five']['5_other_fee'])??''}}">	
													TOTAL Rs.<input style="width:70px;"  type="text" name="five[5_total_fee]" value="{{($decodedDAta['five']['5_total_fee'])??''}}"> 
													</BR>
												</td>
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. GET IFP USE ID 
													<input style="width:70px;"  type="text" name="seven[7_ifp_id]" value="{{($decodedDAta['seven']['7_ifp_id'])??''}}"> AND PASSWORD 
													<input style="width:70px;"  type="text" name="seven[7_ifp_pass]" value="{{($decodedDAta['seven']['7_ifp_pass'])??''}}"> FROM CLIENT. (CREATE NEW ID AND PASSWORD IF THE SAME IS NOT AVAILABLE WITH US.)
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. FILL APPLICATION FORM FROM IFP LOGIN => RENEWAL LICENSE => LICENSE UNDER CLRA ACT.
                                                    </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. IFP ID <input type="text" name="nine[ifp_id]" value="{{($decodedDAta['nine']['ifp_id'])??''}}">& PASSWORD 
													<input type="text" name="nine[ifp_pass]" value="{{($decodedDAta['nine']['ifp_pass'])??''}}">SAVE IN COMPANY MASTER IF COMPANY IS NOT IN SOFTWARE THEN SAVE IN FOLDER .
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													10. ADD FOLLWING DETAILS IN ADDRESS MASTER<BR>
   												     I.  &nbsp;&nbsp;CODE NO. <input type="text" name="ten__one[est_code]" value="{{($decodedDAta['ten__one']['est_code'])??''}}"><BR>
												    II.  &nbsp;COMPANY NAME AND ADDRESS <input type="text" name="ten__two[est_code]" value="{{($decodedDAta['ten__two']['est_code'])??''}}"><BR>
                                                   III.  GST NO. <input type="text" name="ten__three[gst_no]" value="{{($decodedDAta['ten__three']['gst_no'])??''}}"><BR>
												    IV.  &nbsp;CONTACT PERSON NAME AND MOBILE NO.  <input type="text" name="ten__four[est_code]" value="{{($decodedDAta['ten__four']['est_code'])??''}}"><BR>
												     V.  &nbsp;&nbsp;MAIL ID <input type="text" name="ten__five[est_code]" value="{{($decodedDAta['ten__five']['est_code'])??''}}"><BR>
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. PAY LICENSE RENEWAL FEES ONLINE FROM 
													<input type="text" name="eleven[11_sb_ac]" value="{{($decodedDAta['eleven']['11_sb_ac'])??''}}">SB A/C RS.
													<input type="text" name="eleven[11_amt_rs]" value="{{($decodedDAta['eleven']['11_amt_rs'])??''}}">
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="twlve[checkbox]" <?php if(isset($decodedDAta['twlve']['checkbox']) && $decodedDAta['twlve']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													12. SEND APPLICATION NO., OWNER NAME, COMPANY NAME AND NO. OF EMPLOYEES TO SIR</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													13. DOWNLOAD, SAVE & MAIL LABOUR LICENCE COPY</td>
											...
											<tr>
												<td class="p-7">
													...
													14. DO ENTRY IN CALANDER FOR EXPIRING YEAR
												</td>
											...
											<tr>
												<td class="p-7">
													...
													<input type="text" name="fifteen[18_llc_fees]" value="{{($decodedDAta['fifteen']['18_llc_fees'])??''}}">
													</td>
													<td class="p-7">
												...
												<td class="p-7">
													...
													16. MARK THIS TICKET AS CLOSE</td>
													<td class="p-7">
