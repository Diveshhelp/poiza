										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													SEC. DEPOSIT (EE*90) Rs.<input style="width:60px;" type="text" name="five[5_sec_fee]" value="{{($decodedDAta['five']['5_sec_fee'])??''}}">
 													& DD Exp.<input style="width:60px;"  type="text" name="five[5_dd_fee]" value="{{($decodedDAta['five']['5_dd_fee'])??''}}">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. OPEN SHRAM SUVIDHA PORTAL & CREATE USER ID<input style="width:120px;"  type="text" name="seven[7_unam]" value="{{($decodedDAta['seven']['7_unam'])??''}}"> PASSWORD<input  style="width:120px;"  type="text" name="seven[7_pass]" value="{{($decodedDAta['seven']['7_pass'])??''}}">
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. NEW SHRAMSUVIDHA ID <input type="text" name="nine[ifp_id]" value="{{($decodedDAta['nine']['ifp_id'])??''}}">& PASSWORD 
													<input type="text" name="nine[ifp_pass]" value="{{($decodedDAta['nine']['ifp_pass'])??''}}">SAVE IN COMPANY MASTER IF COMPANY IS NOT IN SOFTWARE THEN SAVE IN FOLDER .</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. IF COMPANY IS NOT IN COMPANY MASTER THEN ADD FOLLWING DETAILS IN ADDRESS MASTER<BR>
											...
											<tr>
												<td class="p-7">
													...
													10. FILL THE ONLINE FORM-II FROM LICENSE UNDER CLRA/ISMW</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. PAY REGISTRATION FEES & SECURITY DEPOSIT FROM SHRAM SUVIDHA PORTAL</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="twlve[checkbox]" <?php if(isset($decodedDAta['twlve']['checkbox']) && $decodedDAta['twlve']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													12. DO ENTRY IN CALANDER FOR EXPIRING YEAR</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													13. APPLIED COPY & PAYMENT RECEIPT MAIL TO ESTABLISHMENT</td>
											...
											<tr>
												<td class="p-7">
													...
													16. DOWNLOAD, SAVE & MAIL LICENCE COPY IN FORM-VI</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													17. MARK THIS TICKET AS CLOSE</td>
													<td class="p-7">
