										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. GET BALANCE SHEET FROM DATE OF SET UP OR LAST 5 YEAR WHICH EVER IS OLD
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													14. AUDIT REPORT OR ITR , COMPUTATION OF INCOME</td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													16. FORM - 26AS (FROM DATE OF SET UP OR LAST 5 YEAR WHICH EVER IS OLD)</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													18. INSPECTION IS OVER & VISIT NOTE RECEIVED FORM INSPECTOR ? &nbsp;&nbsp;&nbsp;
												...
												<td class="p-7">
													...
													19. WEATHER DUES ARE GENERATED BY INSPECTOR ? &nbsp;&nbsp;&nbsp;
											...
											<tr>
												<td class="p-7">
													...
													20. IF DUES ARE GENERATED THAN TAKE FOLLOWUP FOR ESI PAYMENT AND PRINT ESI PAID RECEIPT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													21. PREPARE REPLY FOR VISIT NOTE AND MAIL TO ESTABLISHMENT
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													22. SUBMIT REPLY LETTER TO CONCERN ESI OFFICE AND MAIL O/C COPY TO ESATBLISHMENT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													23. DO ENTRY IN ESTABLISHMENT HISTORY IN MENU NO. 16;18</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													24. MARK THIS TICKET AS CLOSED</td>
													<td class="p-7">
