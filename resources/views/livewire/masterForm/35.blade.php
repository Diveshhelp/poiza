                        				...
                        				<table id="employee-grid-35" border="1" class=" table-bordered table-striped responsive fixed-table-layout-user" >
											...
											<tr>
												...
												<td class="p-7">
													...
													2.  TAKE FOLLOW UP TO GET RENEWED DIGITAL SIGNATURE FROM CLIENT.<P STYLE = "COLOR:RED"><B>IF CLIENT IS WILLING TO GET RENEW DSC FROM US THEN SEND CONTECT DETAILS OF ARSHI MEDAM MO. 7575099680 TO CLIENT</B></P>
														...
														<P STYLE = "COLOR:BLUE"><B>IF RENEWAL PROCESS IS STILL NOT INITIATE BY CLIENT THEN GIVE LAST REMINDER BY CALL AND MAIL WITH INFORMATION THAT  “NOW WE WILL INITIATE DSC ACTIVATION PROCESS WHEN YOU SEND DSC TO OUR OFFICE" </B></P>    
											...
											<tr>
												<td class="p-7">
													...
													3.  GET VALID DIGITAL SIGNATURE FROM ESTABLISHMENT PF CODE
													<input style="width:160px;"  type="text" name="one[1_eonm]" value="{{($decodedDAta['one']['1_eonm'])??''}}"> 
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													4.  REGISTERE DSC IN UNIFIED PORTAL ON DATED 
											...
											<tr>	
												<td class="p-7">
													...
													5.  MAIL DSC ACTIVATION LETTER AND SPECIMEN CARD TO ESTABLISHMENT
														<td class="p-7">
											...
											<tr>
												...
												6.  CALL TO ESTABLISHMENT AND EXPLAIN WHERE THEY SUPPOSE TO SIGN AND SEAL
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="six[checkbox]"  <?php if(isset($decodedDAta['six']['checkbox']) && $decodedDAta['six']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7.  GET FOUR COPY OF DSC ACTIVATION LETTER AND SPECIMAN CARD IN HARD COPY
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													8.  INWARD 3 COPY DSC ACTIVATION LETTER AND SPECIMAN CARD TO EPF OFFICE DATED 
											...
											<tr>
												<td class="p-7">
													...
													9.  MAIL RECEIVED COPY OF DSC ACTIVATION LETTER AND SPECIMAN CARD TO CONCERN EPF OFFICE AND CLIENT 
													</td>
													<td class="p-7">
												...
												<td class="p-7"><input type="checkbox" name="five[checkbox]"  <?php if(isset($decodedDAta['five']['checkbox']) && $decodedDAta['five']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10.  UPLOAD SIGNED DSC ACTIVATION LETTER AND SPECIMAN CARD IN UNIFIED PORTAL DATED 
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													11.  SEND 1ST REMINDER MAIL FOR DSC ACTIVATION AFTER 2 WORKING DAYS AFTER DATE OF INWARD.  DATED
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
												    12. SEND 2ND REMINDER MAIL NEXT DAY. DATED 
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]"  <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													13. SEND 3RD REMINDER MAIL NEXT DAY. DATED 
...
<?php /* 
											<tr>
												<td class="p-7">
													...
													14. IF DSC IS NOT ACTIVE TILL DATE THEN FILE GRIEVANCE AT
												    ...
												    <?php if(isset($decodedDAta['one']) && $decodedDAta['one']['1_eonm']!="" && $decodedDAta['two']['2_from']!="" && $decodedDAta['five']['5_from']!="" && $decodedDAta['seven']['7_from']!=""){?>
...
*/ ?>
                                            <tr>
												<td class="p-7">
													...
													14.  SAVE GREVIANCE REGISTRATION NUMBER :
											...
											<tr>
												<td class="p-7">
													...
													15. STILL NOT ACTIVATED THEN WAIT UPTO 15 DAYS, IF NOT ACTIVATED THEN INFORM TO HIGHER AUTHORITY
											...
											<tr>
												<td class="p-7">
													...
													16. UPDATE THE FINAL DSC ACTIVATION STATUS IN SOFTWARE > ADMIN > DIGITAL MANAGEMENT > ADD/EDIT DIGITAL ENTRY > SELECT COMPANY > SELECT DIGITAL SIGNATURE > UPDATE STATUS IN REQUIRED ROW  AND CLOSE THE TICKET</td>
													<td class="p-7">
