										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													8. NEW G.L.W.F. ID
														...
														<input type="text" name="eight[8_glwf_pass]" value="{{($decodedDAta['eight']['8_glwf_pass'])??''}}">SAVE IN 2,25 SCREEN NO 10. <BR>IF COMPANY IS NOT IN SOFTWARE THEN SAVE IN ITS FOLDER.</BR>
												    </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. UPDATE REGISTRATION ENTRY IN SPREAD SHEET AVAILABLE IN GMAIL>DHIRUBHAI LABLE
												...
												<td class="p-7"><input type="checkbox" name="twelve[checkbox]" <?php if(isset($decodedDAta['twelve']['checkbox']) && $decodedDAta['twelve']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													12. UPDATE GLWF REPORTING IN REPORT MASTER MENU NO. 16;5 IN THE SOFTWARE OF RESPECTIVE EMPLOYEES
													</td>
												<td class="p-7">
