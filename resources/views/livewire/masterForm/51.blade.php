										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													1. DOCUMENT RECEIVED FOR AMENDMENT OF FACTORY LICENCE
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													4. <B>AMANDMENT APPLY DETAILS :</B><BR>NO. OF EMPLOYEES
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="six[checkbox]"  <?php if(isset($decodedDAta['six']['checkbox']) && $decodedDAta['six']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													6. FILL ONLINE FORM FROM DISH GUJARAT > E SHRAM SEVA>FACTORY LICENSE AMENDMENT > LOG IN WITH ID <B>rajconrjt@gmail.com</B> & PASSWORD <B>Rajcon*105</B> > NEW APPLICATION
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. DETAILS WITH > FACTORY SEARCH > SELECT AMENDMENT TYPE > UPDATE THE AMENDMENT DETAILS > UPLOAD DOCUMENTS > PAY THE REQUIRED FEES. 
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. DOWNLOAD ONLINE FORM 2 & 3, PRINT FORM 2 IN FOUR COPIES AND FORM 3 IN THREE COPIES. </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. IF IN AMENDMENT, THERE IS CHANGE IN NUMBER OF EMPLOYEES THEN ATTACHED BOTH THE MUSTER ONE IS OLD  & SECOND  IS WITH INCREASED NUMBER OF EMPLOYEE DETAILS</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. PREPARE FORWARDING LETTER ON LETTER HEAD IN TWO COPIES
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]"  <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													11. CALL TO AUTHORISED PERSON FOR SIGNING THE DOCUMENTS
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													12.  APPLICATION INWARD TO FACTORY ACT OFFICE ON DATE :
											...
											<tr>
												<td class="p-7">
													...
													13.  INSERT BILL ENTRY IN EXCELL SHEET SAVED IN THE LABLE OF DHIRUBHAI OF RS.
														<input style="width:120px;"  type="text" name="sixteen[mobile_number]" value="{{($decodedDAta['sixteen']['mobile_number'])??''}}">
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													14. DOWNLOAD THE FACTOLY LICENSE & MAIL TO ESTABLISHMENT
													</td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													15. DO ENTY IN CALANDER FOR EXPIRE YEAR
														<td class="p-7">
                                            ...
                                            <tr>
												<td class="p-7">
													...
													16. IF COMPANY IS NOT EXISTING IN OUR SOFTWARE THEN FOR BILL PURPOSE ADD IT IN ADDRESS MASTER
												 </td>
													</td>
													<td class="p-7">
