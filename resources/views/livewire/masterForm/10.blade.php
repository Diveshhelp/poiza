										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													5. RENEUAL DATA : REG. FEE Rs.<input style="width:70px;" type="text" name="five[5_reg_fee]" value="{{($decodedDAta['five']['5_reg_fee'])??''}}">, 
													CONSULTING FEES RS.<input style="width:70px;" type="text" name="five[5_con_fee]" value="{{($decodedDAta['five']['5_con_fee'])??''}}">
 													OTHER EXPANSE <input style="width:70px;"  type="text" name="five[5_other_fee]" value="{{($decodedDAta['five']['5_other_fee'])??''}}">
													TOTAL Rs.<input style="width:70px;"  type="text" name="five[5_total_fee]" value="{{($decodedDAta['five']['5_total_fee'])??''}}"> RENEWAL APPLICATION MUST SUBMIT ATLEAST ONE MONTH PRIOR TO EXPIRY DATE, OR ELSE CONSIDER 25% OF PENELTY ON REGISTRATION RENEWAL FEES
												</td>
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. PAY LICENSE RENEWAL FEES ONLINE AT NTRP PORTAL => NON REGISTER USERS => PURPOSE-LABOUR & EMPLOYMENT => SEARCH-LICENSE FEE UNDER CLRA -1970 => REMARKS-LABOUR LICENSE RENEWAL FEES, LICENSE NO......
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. FILL APPLICATION FORM IN FORM - II & PRINT IN 3 COPY, ONE IS OC. FORMAT SAVED IN Z ACT => LABOUR LICENSE => Z LABOUR LICENCE CENTRAL => LLC RENEWAL FORMS</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. PREPARE FORWARDING LETTER & PRINT IN 2 COPY, ONE IS OC. FORMAT SAVED IN Z: ACT->LLC->LL CENTRAL RENEWAL </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													10. CALL TO AUTHORISED PERSON FOR SIGNING DOCUMENTS AND PREPARE SET OF DOCUMENT AS PER THE CHECK LIST.</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. APPLICATION INWARD TO LABOUR COMM (C) OFFICE ON DT
														<input type="text"  name="three[11_from]" class="onetime"  value="{{($decodedDAta['three']['11_from'])??''}}"> 
														</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="twlve[checkbox]" <?php if(isset($decodedDAta['twlve']['checkbox']) && $decodedDAta['twlve']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													12. O/C COPY MAIL TO ESTABLISHMENT</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													13. DO ENTRY IN CALANDER FOR EXPIRY DATE</td>
											...
											<tr>
												<td class="p-7">
													...
													16. SCAN, SAVE & MAIL LICENCE COPY IN FORM-VI</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													17. ADD COMPANY NAME & ADDRESS IN OUR SOFTWARE FROM MENU NO. 2;1;10;7 IF COMPANY IS NOT IN SOFTWARE</td>
													<td class="p-7">
