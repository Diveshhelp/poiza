										...
										<table class="w-100" border="1">
											...
											<tr>
												<td class="p-7">
													...
													4. OLD EMPLOYEE 
													<input style="width:70px;" type="text" name="four[4_old_ee]" value="{{($decodedDAta['four']['4_old_ee'])??''}}"> + ADDITIONAL EMPLOYEES
													<input style="width:70px;" type="text" name="four[4_add_ee]" value="{{($decodedDAta['four']['4_add_ee'])??''}}">TOTAL EMPLOYEES = 
													<input style="width:70px;"  type="text" name="four[4_tot_ee]" value="{{($decodedDAta['four']['4_tot_ee'])??''}}">
													</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													5. REG. FEE Rs.<input style="width:70px;" type="text" name="five[5_reg_fee]" value="{{($decodedDAta['five']['5_reg_fee'])??''}}">, 
													SEC. DEPOSIT (EE*540) Rs.<input style="width:70px;" type="text" name="five[5_sec_fee]" value="{{($decodedDAta['five']['5_sec_fee'])??''}}">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. PREPARE SECURITY DEPOSITE CHALLAN & DO SIGN AND SEAL OF CONCERN LABOUR OFFICE AND PAY AT TREASURY BRANCH</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													8. CREATE NEW REGISTRATION AT: COL.GUJARAT, LINK IS https//col.gujarat.gov.in/
                                                    </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="nine[checkbox]" <?php if(isset($decodedDAta['nine']['checkbox']) && $decodedDAta['nine']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													9. USE ID OF IFP PORTAL WHICH IS USED AT THE TIME OF NEW APPLICATION OF LICENSE
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													10. RESET PASSWORD BY USING FORGOT PASSWORD</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]" <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled"; }?>>
													11. LOGIN INTO COL.GUJARAT => E SHRAM SEVA => APPLICATION FOR AMENDMENT IN LICENSE USING ID & PW OF LICENSE & APPLY FOR AMENDMENT APPLICATION NEW APPLI.</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="twlve[checkbox]" <?php if(isset($decodedDAta['twlve']['checkbox']) && $decodedDAta['twlve']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													12. GO TO NEW APPLICATION => CLICK ON ESTABLISHMENT NAME => SELECT LICENSE NUMBER</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													13. FILL UP ALL DETAILS IN FORM AND SUBMIT THE APPLICATION AND NOTE APPLICATION NO. 
													<input type="text" name="thirteen[18_llc_fees]" value="{{($decodedDAta['thirteen']['18_llc_fees'])??''}}"></td>
											...
											<tr>
												<td class="p-7">
													...
													14. PAY LICENSE RENEWAL FEES ONLINE FROM
												    <input type="text" name="fourteen[11_sb_ac]" value="{{($decodedDAta['fourteen']['11_sb_ac'])??''}}">SB A/C RS.
													<input type="text" name="fourteen[11_amt_rs]" value="{{($decodedDAta['fourteen']['11_amt_rs'])??''}}">
												</td>
											...
											<tr>
												<td class="p-7">
													...
													15. SEND APPLICATION NO., OWNER NAME, COMPANY NAME AND NO. OF EMPLOYEES TO SIR
													</td>
													<td class="p-7">
												...
												<td class="p-7">
													...
													16. INSERT BILL ENTRY IN EXCELL SHEET SAVED IN THE LABLE OF DHIRUBHAI OF RS.
													<input type="text" name="sixteen[16_raj_fees]" value="{{($decodedDAta['sixteen']['16_raj_fees'])??''}}">
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													17. DOWNLOAD, SAVE & MAIL LABOUR LICENCE COPY
													</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													18. IF COMPANY IS NOT EXISTING IN OUR SOFTWARE THEN FOR BILL PURPOSE ADD IT IN ADDRESS MASTER</td>
														<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													19. MARK THIS TICKET AS CLOSE</td>
														<td class="p-7">
