										...
										<table class="w-100" border="1">
													...
													<BR>
													   ...
													   III. MAIL ID <input style="width:120px;"  type="text" name="two_four[mobile_number]" value="{{($decodedDAta['two_four']['mobile_number'])??''}}"><BR> 
													    IV. PF USER ID <input style="width:120px;"  type="text" name="two_five[mobile_number]" value="{{($decodedDAta['two_five']['mobile_number'])??''}}"> AND PASSWORD <input style="width:120px;"  type="text" name="two_six[mobile_number]" value="{{($decodedDAta['two_six']['mobile_number'])??''}}"><BR>
													     ...
													     V. MASTER DOCUMENTS <input style="width:120px;"  type="text" name="two_nine[mobile_number]" value="{{($decodedDAta['two_nine']['mobile_number'])??''}}">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="seven[checkbox]"  <?php if(isset($decodedDAta['seven']['checkbox']) && $decodedDAta['seven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													7. AFTER CONFIRMATION CHANGE THESE DETAILS IN PORTAL THEN CHANGE IT FROM LOGIN>ESTABLISHMENT>CONTACT DETAILS
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="ten[checkbox]"  <?php if(isset($decodedDAta['ten']['checkbox']) && $decodedDAta['ten']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													10. DOWNLOAD PF CODE ALLOTMENT LETTER & FORM 5A FROM EPFO UNIFIED PORTAL
											    	</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7"><input type="checkbox" name="eleven[checkbox]"  <?php if(isset($decodedDAta['eleven']['checkbox']) && $decodedDAta['eleven']['checkbox']=="on") { echo "checked=checked"; echo " disabled";}?>>
													11. OLD ECR & CRN DOWNLOAD FROM E-SEVA & SAVE IN RAJKOT FOLDER
												</td>
												<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													12. OPEN ESTABLISHMENT IN OUR SOFTWARE WITH HELP OF ESTABLISHMENT SEARCH LINK IS <BR>
	                                        ...
	                                        <tr>
												<td class="p-7">
													...
													13. UPDATE GST CERTIFICATE NO. IN COMPANY MASTER
</td></td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													14. UPDATE MAIL ID IN COMPANY MASTER, IF EST IS PERTAINING TO ANY BRANCH THEN ADD MAIL ID OF BRANCH IN CC
 </td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													15. ADD CONTACT NO WITH EST NAME IN jignashanumbers2@gmail.com
</td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													17. MAIL ID SAVE IN GMAIL rajconrjt@gmail.com AND ASSIGN LABLE AS PER THE ALPHABATES OF THE COMPANY
</td>
													<td class="p-7">
...
<tr>
												<td class="p-7">
													...
													18. IF EST IS PERTAINING TO ANY BRANCH THEN ADD IN GMAIL BRANCH IN CC
</td>
													<td class="p-7">
...
<tr>
											...
											<tr>
												<td class="p-7">
													...
													21. UPDATE WORK START FROM ENTRY IN SPREAD SHEET AVAILABLE IN GMAIL>DHIRUBHAI LABLE
												...
												<td class="p-7">
													...
													22. IF DSC IS WITH US THEN UPDATE THE INWARD ENTRY IN SOFTWARE AND CREATE A TICKIT FOR DSC ACTIVATION
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													23. VERIFY THE DSC ACTIVATION STATUS FROM PF LOGIN>ESTABLISHMENT>DSC/ESIGN>VIEW REGISTERED DSC
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													24. IF DSC IS NOT REGISTER THEN CREATE A TICKIT FOR DSC ACTIVATION
											...
											<tr>
												...
												25. EDIT REPORT MASTER AS PER THE WORK OF ESTABLISHMENT
											...
											<tr>
												...
												26. SELECT MUSTER & WAGE REGISTER FORMAT IF IN REPORT MASTER BOTH REPORT SELECTED UNDER THE HEAD "PAY ROLL REGULAR WORK"
											...
											<tr>
												<td class="p-7">
													...
													27. SELECT HEAD OF MUSTER AND WAGE REIGSTER IN COMPANY MASTER
											...
											<tr>
												<td class="p-7">
													...
													28. SELECT FORMATE OF WAGE SLIP 
											...
											<tr>
												<td class="p-7">
													...
													29. DOWNLOAD ACTIVE MEMBER SHEET AND EXITED MEMBER SHEET FROM EPFO
</td>
													<td class="p-7">
	                                        ...
	                                        <tr>
												<td class="p-7">
													...
													30. PREPARE EMPLOYEE MASTER IN OUR SOFTWARE OF ALL LIVE AND EXITED EMPLOYEES
                                            ...
                                            <tr>
												<td class="p-7">
													...
													31. UPLOAD SALARY DATA AS PER LAST MONTH'S ECR & GIVE DUMMY RESIGN TO ALL REMAINING EMPLOYEES
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													32.UPDATE WORK START ENTRY IN SPREAD SHEET AVAILABLE IN GMAIL>DHIRUBHAI LABLE
</td>
													<td class="p-7">
											...
											<tr>
												<td class="p-7">
													...
													33.DESIGN EXCEL SALARY STRUCUTRE AS PER THE REQUIREMENT OF THE COMPANY
</td>
													<td class="p-7">
