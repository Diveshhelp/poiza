            ...
            <div class="md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    <h3 class="text-lg font-medium text-gray-900">
                        {{ $isUpdate ? 'Edit Photos' : 'Add New Photos' }}
                    </h3>
                    <p class="mt-2 text-sm text-gray-600 leading-relaxed">
                        {{ $isUpdate ? 'Update Your photos' : 'Add Your photos' }}
                    </p>
                </div>
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 justify-center">
                                                <label for="mediaFiles"
                                                    ...
                                                    <input id="mediaFiles" type="file" wire:model="mediaFiles" accept="image/*" class="sr-only" multiple>
                                                </label>
                                            </div>
                        ...
                        <div class="flex items-center justify-end px-3 py-2 bg-gray-50 text-end sm:px-4 shadow sm:rounded-bl-md sm:rounded-br-md">
                            <button type="submit"
                                ...
                                <span class="indicator-label" wire:loading.remove wire:target="savePhoto">
                                    {{ $isUpdate ? 'Update Photos' : 'Save Photos' }}
                                </span>
