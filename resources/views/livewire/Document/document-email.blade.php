...
>
    <div 
        ...
        class="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-md m-4"
    >
        ...
        <form wire:submit.prevent="sendAttachments">
            <div class="p-6">
                ...
                <div class="text-xs text-gray-500">
                    All attachments associated with this document will be sent to the email address above.
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 rounded-b-lg border-t border-gray-200 flex justify-end space-x-3">
                ...
                <span wire:loading.remove wire:target="sendAttachments">Send Attachment</span>
