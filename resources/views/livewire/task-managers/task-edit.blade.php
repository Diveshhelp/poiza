                        ...
                        <div class="mt-3 px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                            <div class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-3">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <div x-data="{
                                        ...
                                        @keydown="handleKeyDown($event)" class="relative mt-2">
                                        <!-- Selected department display -->
                                        <div @click="open = !open; $nextTick(() => open ? $refs.searchInput.focus() : null)"
                                            ...
                                            <div x-text="selectedLabel || 'Select Department'" class="text-sm"
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            <!-- Department list -->
                                            <template x-for="(dept, index) in filteredDepartments"
                                                :key="dept.id">
                                                <div @click="selectDepartment(dept.id, dept.department_name)"
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <div x-data="{
                                        ...
                                        <div @click="if (!{{ empty($department) ? 'true' : 'false' }}) { open = !open; }"
                                            ...
                                            :class="{
                                                ...
                                                'hover:border-gray-400': !open && !
                                                    {{ empty($department) ? 'true' : 'false' }}
                                            }">
                                            <div x-text="selectedLabel || '{{ empty($department) ? 'Please select a department first' : 'Select Sub Department' }}'"
                                                class="text-sm" :class="{ 'text-gray-500': !selectedLabel }">
                                            </div>
                                            <svg class="h-5 w-5 text-gray-400" :class="{ 'transform rotate-180': open }"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            <!-- Search input -->
                                            <div class="px-3 py-2 sticky top-0 bg-white border-b">
                                                <input tabindex="2" x-ref="searchInput" x-model="search"
                                                    @keydown.escape.prevent.stop="open = false"
                                                    @keydown.up.prevent.stop="handleKeyDown($event)"
                                                    @keydown.down.prevent.stop="handleKeyDown($event)"
                                                    @keydown.enter.prevent.stop="handleKeyDown($event)"
                                            ...
                                            <template x-if="filteredItems.length === 0 && !isLoading">
                                                <div class="px-4 py-2 text-gray-500 text-sm">No sub departments found
                                                </div>
                                            </template>

                                            <!-- Item list -->
                                            <template x-for="(item, index) in filteredItems" :key="item.id">
                                                <div @click="selectSubDepartment(item.id)"
                                                    @mouseover="highlightedIndex = index"
                                                    class="px-4 py-2 cursor-pointer hover:bg-indigo-50 text-sm"
                                                    :class="{
                                                        'bg-indigo-50 text-indigo-900': selectedSubDepartment == item
                                                            .id,
                                                        'bg-indigo-100': highlightedIndex === index &&
                                                            selectedSubDepartment != item.id
                                                    }">
                                    ...
                                    <!-- Hidden select to maintain Livewire validation -->
                                    <select wire:model.live="subDepartments" class="hidden">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <select wire:model="status"
                                        class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        <option value="not_started">Work Not Started</option>
                                ...
                                <!-- Repetition -->
                                <div class="sm:col-span-1">
                                    <label class="block font-medium text-sm text-gray-700" for="repetition">Work
                                        Repetition</label>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    @if ($repetition === 'weekly')
                                        <label class="block font-medium text-sm text-gray-700"
                                            for="work_detail">Repeat Option</label>
                                        <div class="mt-2 m-5">
                                            @foreach ($this->getWeekDays() as $value => $label)
                                                <label class="inline-flex items-center">
                                                    <input type="checkbox" wire:model="weekDays"
                                                        value="{{ $value }}"
                                    ...
                                    @if ($repetition === 'quarterly')
                                        <label class="block font-medium text-sm text-gray-700"
                                            for="work_detail">Repeat Option</label>
                                        <select wire:model="selectedQuarter"
                                            class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    ...
                                    @if ($repetition === 'half_yearly')
                                        <label class="block font-medium text-sm text-gray-700"
                                            for="work_detail">Repeat Option</label>
                                        <select wire:model="selectedHalfYear"
                                            class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                ...
                                <div class="sm:col-span-2 mt-3">
                                    ...
                                    <div class="flex flex-wrap items-center gap-x-6 gap-y-2">
                                        ...
                                        <div class="flex items-center">
                                            <input type="radio" id="repeat-never" wire:model.live="repeatUntilType"
                                                value="never"
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex items-center">
                                                <input type="radio" id="repeat-date"
                                                    wire:model.live="repeatUntilType" value="date"
                                                    class="form-radio rounded-full border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-600">
                                                <label for="repeat-date" class="ml-2">Until Date</label>
                                            </div>

                                            <div class="ml-2 transition-all duration-200 max-w-xs"
                                                :class="{ 'opacity-100': '{{ $repeatUntilType }}'
                                                    === 'date', 'opacity-50': '{{ $repeatUntilType }}'
                                                    !== 'date' }">
                                                <input wire:model="repeatUntilDate" type="date"
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex items-center">
                                                <input type="radio" id="repeat-occurrences"
                                                    wire:model.live="repeatUntilType" value="occurrences"
                                                    class="form-radio rounded-full border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-600">
                                            ...
                                            <div class="mx-2 transition-all duration-200 w-20"
                                                :class="{ 'opacity-100': '{{ $repeatUntilType }}'
                                                    === 'occurrences', 'opacity-50': '{{ $repeatUntilType }}'
                                                    !== 'occurrences' }">
                                                <input wire:model="maxOccurrences" type="number" min="1"
                                                    class="block w-full rounded-md border-0 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                                    :disabled="'{{ $repeatUntilType }}'
                                                    !== 'occurrences'">
                                            </div>
                                    ...
                                    <div class="mt-1 flex space-x-4">
                                        <div class="text-red-500" x-show="'{{ $repeatUntilType }}' === 'date'">
                                            @error('repeatUntilDate')
                                                {{ $message }}
                                            @enderror
                                        </div>
                                        <div class="text-red-500"
                                            x-show="'{{ $repeatUntilType }}' === 'occurrences'">
                                            @error('maxOccurrences')
                                                {{ $message }}
                                            @enderror
                                        </div>
                                    </div>
                            ...
                            <div class="sm:col-span-2">
                                <label class="block font-medium text-sm text-gray-700" for="work_detail">Work
                                    Detail</label>
                                <textarea wire:model="work_detail" rows="3"
                            ...
                            <div class="sm:col-span-2  mt-5 ">
                                <label for="mediaFiles" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <!-- Loading State -->
                                <div wire:loading wire:target="mediaFiles" class="mt-2">
                                                ...
                                                <div class="relative group">
                                                    <div
                                                        ...
                                                        @if (str_contains($file->getMimeType(), 'image'))
                                                            <!-- Image Preview -->
                                                            <div
                                                                class="relative h-20 w-20 mr-3 rounded-lg overflow-hidden">
                                                        ...
                                                        @else
                                                            <!-- Document Icon -->
                                                            <div
                                                                class="flex items-center justify-center h-20 w-20 mr-3 bg-gray-200 rounded-lg">
                                        ...
                                        @foreach ($media_files as $file)
                                            <div class="relative group">
                                                <div
                                                    ...
                                                    <!-- Remove Button -->
                                                    <button type="button"
                                                        wire:click="removeUploadedFile('{{ base64_encode($file->id) }}')"
