<div>
    <div class="max-w-7xl mx-auto py-2 sm:px-6 lg:px-8" wire:key="todo-manager-module-{{ time() }}">
        <div>
            <div class="md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    <h3 class="text-lg font-medium text-gray-900">
                        {{ $isUpdate ? 'Edit Todo' : 'Add new Todo' }}
                    </h3>
                    <p class="mt-2 text-sm text-gray-600 leading-relaxed">
                        {{ $isUpdate ? 'Update your todo details and track your progress' : 'Add your todo details and track your progress' }}
                    </p>
                </div>
                    ...
                    @include('livewire.common.messages')
                        <div class="mt-2 px-3 py-3 bg-white sm:p-4 shadow sm:rounded-tl-md sm:rounded-tr-md">
                            <div class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                                <div class="sm:col-span-1">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" autofocus wire:model="title" id="title"
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea wire:model="description" rows="2"
                                        class="mt-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                    <div class="text-red-500">
                                        @error('description')
                                            <span class="text-xs">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 justify-center">
                                                <label for="mediaFiles"
                                                    ...
                                                    <input id="mediaFiles" type="file" wire:model="mediaFiles" class="sr-only" multiple>
                                                </label>
                                            </div>

                                            <p class="text-xs text-gray-500">PNG, JPG, GIF, PDF, DOC, DOCX</p>
                                        </div>
                                    </div>
                        ...
                        <div class="flex items-center justify-end px-3 py-2 bg-gray-50 text-end sm:px-4 shadow sm:rounded-bl-md sm:rounded-br-md">
                            <button type="submit"
                                ...
                                <span class="indicator-label" wire:loading.remove wire:target="saveTodo">
                                    {{ $isUpdate ? 'Update Todo' : 'Create Todo' }}
                                </span>
                                <span class="indicator-progress" wire:loading wire:target="saveTodo">
